...
decks = [[int(n) for n in i.splitlines()[1:]] for i in open('../in/input22.txt').read().split('\n\n')]
...
if decks[0]: print("part 1:",sum(i * decks[0][-i] for i in range(1, 51)))
else:        print("part 1:",sum(i * decks[1][-i] for i in range(1, 51)))
...
decks = game(decks)
if decks[0]: print("part 2:",sum(i * decks[0][-i] for i in range(1, 51)))
else:        print("part 2:",sum(i * decks[1][-i] for i in range(1, 51)))